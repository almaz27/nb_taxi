...
/* @var $searchModel backend\modules\carForTaxi\models\RentingRecordSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Renting Records';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="renting-record-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' Renting Records','class'=>'btn btn-outline-primary']).
